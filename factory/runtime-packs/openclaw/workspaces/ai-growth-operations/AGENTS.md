# AGENTS.md - ai-growth-operations

This workspace is generated from Meta_Kim Agent Foundry.

- Primary routing owner: `ai-growth-operations`
...
- Specialist slots live under `factory/agent-library/specialists/ai/growth-operations/`.
