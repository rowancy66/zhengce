# AGENTS.md - real-estate-risk-compliance

This workspace is generated from Meta_Kim Agent Foundry.

- Primary routing owner: `real-estate-risk-compliance`
...
- Specialist slots live under `factory/agent-library/specialists/real-estate/risk-compliance/`.
