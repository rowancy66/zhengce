# AGENTS.md - game-strategy-office

This workspace is generated from Meta_Kim Agent Foundry.

- Primary routing owner: `game-strategy-office`
...
- Specialist slots live under `factory/agent-library/specialists/game/strategy-office/`.
